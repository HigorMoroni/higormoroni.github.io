...
function modoNoturno() {
    ...
    conjunto.addEventListener('click', e => {
        ...
        const tema = elemento.getAttribute("tema");
        if (tema === 'diurno') {
            const temaAtual = linkTema.getAttribute("href");
            if (temaAtual === 'assets/css/themes.dark.css') {
                linkTema.removeAttribute('href','assets/css/themes.dark.css')
                linkTema.setAttribute('href','assets/css/themes.light.css')
            }
        } else if (tema === 'noturno') {
            const temaAtual = linkTema.getAttribute("href");
            if (temaAtual === 'assets/css/themes.light.css') {
                linkTema.removeAttribute('href','assets/css/themes.light.css')
                linkTema.setAttribute('href','assets/css/themes.dark.css')
            }
        }
    })
}
